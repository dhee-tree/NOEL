...
class loginForm(forms.Form):
    username = forms.EmailField(max_length=usernameLength, required=True, widget=forms.TextInput(
        attrs={'class': 'form-control', 'id': 'username', 'name': 'username', 'placeholder': 'Enter username'}))
